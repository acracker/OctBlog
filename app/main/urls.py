...
blog_admin.add_url_rule('/wechats/', view_func=admin_views.PostsList.as_view('wechats'),
                        defaults={'post_type': 'wechat'})
blog_admin.add_url_rule('/wechats/draft/', view_func=admin_views.DraftList.as_view('wechat_drafts'),
                        defaults={'post_type': 'wechat'})
blog_admin.add_url_rule('/new-wechat/', view_func=admin_views.Post.as_view('new_wechat'),
                        defaults={'post_type': 'wechat'})
...
blog_admin.add_url_rule('/posts/comments/approved/', view_func=admin_views.Comment.as_view('comments_approved'),
                        defaults={'status': 'approved'})
blog_admin.add_url_rule('/posts/comments/spam/', view_func=admin_views.Comment.as_view('comments_spam'),
                        defaults={'status': 'spam'})
