...
from wtforms import StringField, TextAreaField, HiddenField, RadioField, FileField, \
    IntegerField
...
SuPostForm = model_form(models.Post,
                        exclude=['pub_time', 'update_time', 'content_html', 'category', 'tags', 'post_type'])
